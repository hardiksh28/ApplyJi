  ...
  return (
    <div className="w-64 glass-panel h-screen flex flex-col p-4">
      <div className="flex items-center gap-2 px-2 mb-10">
        <div className="w-8 h-8 bg-brand-primary rounded-lg flex items-center justify-center font-bold text-white italic text-lg shadow-lg shadow-brand-primary/20">
          A
        </div>
        <h1 className="text-xl font-bold tracking-tight text-white">ApplyJi</h1>
      </div>
